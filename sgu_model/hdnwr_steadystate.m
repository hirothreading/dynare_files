function [ys, params, info] = hdnwr_steadystate(ys, exo, M_, options_)
% Steady-state file for hdnwr.mod
% Schmitt-Grohe and Uribe (2025) -- Endogenous Labor Supply version
%
% Dynare calls this file automatically (instead of a steady_state_model
% block) because it matches the .mod filename.  The companion file is
% needed here because solving for jstar requires fzero.
%
