...
%
% 10 endogenous variables, 10 equations (8 structural + 2 shock processes)
...
%--------------------------------------------------------------------------
% Steady State  (computed in hdnwr_steadystate.m)
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
shocks;
  var eps_mu = 0.01^2;    % 1% std dev monetary shock
  var eps_a  = 0.01^2;    % 1% std dev technology shock
end;
...
% First-order perturbation, IRFs for 20 quarters
stoch_simul(order=1, irf=20) y h u w pi piW ii jstar;
